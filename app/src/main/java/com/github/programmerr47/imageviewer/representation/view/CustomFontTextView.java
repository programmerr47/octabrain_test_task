...
import com.github.programmerr47.imageviewer.util.Constants;
...
public class CustomFontTextView extends TextView {
    ...
    public void setFontName(Constants.Font font) {
        if (font != null) {
            Typeface typeface = Typeface.createFromAsset(getContext().getAssets(), Constants.ASSETS_FONTS_DIR + font.getFontName());
            setTypeface(typeface);
        }
    }
}
